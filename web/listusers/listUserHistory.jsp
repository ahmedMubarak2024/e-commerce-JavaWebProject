                        ...
                        <table>
                            <thead>
                                <tr class="table100-head">
                                    ...
                                    <th class="column2">Item Category</th>
                                    <th class="column3">Quantity</th>
                                    <th class="column4">Item Price</th>
                                    <th class="column5">Date of Buying</th>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="temp" items="${userHistroyList}">
                                    


                                    <tr>
                                        <td class ="column1"> ${temp.itemName} </td>
                                        <td class ="column2"> ${temp.itemCategory} </td>
                                        <td class ="column3"> ${temp.quantity} </td>
                                        <td class ="column4"> ${temp.itemPrice} </td>
                                        <td class ="column5"> ${temp.time} </td>
